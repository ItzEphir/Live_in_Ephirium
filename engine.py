...
def button(x, y, width, height, message, color=0, activeColor=0, colorTitle=(0, 0, 0), activeColorTitle=0,
           hitBoxX=50, hitBoxY=10, font_size=25, image=None):   # положение кнопки, размер кнопки, надпись,
                                                                # цвет, цвет при наведении,
                                                                # цвет текста, активный цвет текста,
                                                                # регуляровка хитбоксов, размер шрифта, картинка кнопки
